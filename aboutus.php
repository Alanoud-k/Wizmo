    ...
    <main>
        <section class="about-us-section">
            <div class="container">
                <h2>About Us</h2>
                <p>
                    Wizmo is a user-friendly platform designed to streamline warehouse inventory management for SMEs.
                </p>
                <p>Our platform offers the following key features:

                    <ul>
                        <li>
                          <strong>Product Warehouse:</strong>
                          <ul>
                            <li>✅ Add & store products</li>
                            <li>✏ Edit or delete information</li>
                            <li>🔴 Red alert for low stock</li>
                          </ul>
                        </li>
                        <li>
                          <strong>Distribution Deals:</strong>
                          <ul>
                            <li>➕ Add external distributor deals</li>
                          </ul>
                        </li>
                        <li>
                          <strong>Community:</strong>
                          <ul>
                            <li>🔍 Find businesses in different categories & cities</li>
                        ...
                        <li>
                          ...
                          <ul>
                            <li>📩 View incoming requests (Accept/Decline)</li>
                            <li>✔ Accepted requests appear in a list</li>
                          </ul>
                        </li>
                      </ul>
                </p>
        ...
        <section class="vision-section">
            <div class="container">
                <h2>Our Vision</h2>
                <p>
                    Our vision is to empower Small and Medium-sized Enterprises (SMEs) by revolutionizing their warehouse operations. We aim to eliminate the challenges of inefficient inventory management, fragmented distribution, and isolated operations by providing a streamlined, collaborative platform. Through our Warehouse Management System, SMEs will achieve real-time stock visibility, seamless product distribution, and a thriving community network, ultimately minimizing stock shortages, optimizing resources, and fostering local business collaboration.
                </p>
            </div>
        </section>
    </main>
